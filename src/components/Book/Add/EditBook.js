...
export default function EditBook() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // const response = await axios.get('http://localhost/DBS_Project/PHP/GetSingleBook.php?id='+id);
        // console.log(response.data);

        axios.get('http://localhost/DBS_Project/PHP/GetSingleBook.php?id='+id+'&user='+Username).then(response => {
    ...
    const handleChange = () => {
            ...
            const url = 'http://localhost/DBS_Project/PHP/UpdBook.php'
